...
fun AboutSettingsSection() {
    ...
    Column(Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(12.dp)) {
        ...
        Text("Android Media3 handles decoding and the media session. XvoxMix offers smoothed 5/10-band EQ, manual boost protection, peak limiting, gentle noise/high-frequency controls and a headphone spatial effect. Optional crossfade uses overlapping players and local rhythm/energy analysis. Effects alter the audio signal: this is not a claim of bit-perfect output or universal beat matching.",
            color = colors.secondaryText, fontSize = 11.sp, lineHeight = 16.sp)
